        ...
        <div className="w-[43rem] lg:w-[66rem] h-[40.5rem] mx-auto my-[1.3rem] bg-[#FBF6F6] dark:bg-gray-700 border-[1px] rounded-lg shadow-2xl">
          ...
          >
            <Form>
              ...
              <button className="text-[#ffff] dark:text-white text-sm bg-[#158B68] dark:bg-gray-900 border-[2px] border-[#158B68] rounded-lg w-[24rem] lg:w-[29rem] h-[3.5rem] lg:h-[4rem] absolute top-[20rem] lg:top-[20rem] right-[15rem] lg:right-[30rem]">
                تایید
              </button>
            </Form>
          </Formik>
