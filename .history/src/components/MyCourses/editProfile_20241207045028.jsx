            ...
            <>
              <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="w-[30rem] my-6 mx-auto max-w-3xl">
                  <div className=" dark:text-wborder-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white dark:bg-gray-800 outline-none focus:outline-none">
                    <button
                      type="button"
                      ...
                      <div class="w-full dark:bg-gray-700 py-9 bg-[#f1f1f1]  gap-3 grid border-green-300">
                        ...
                        <div class="grid gap-2">
                          ...
                          <div class="flex items-center justify-center">
                            <label>
                              <Form>
                                <Field   onChange={fileImg} type="file" name="file" hidden></Field>
