  ...
  return (
    <>
          ...
          <div className="mt-16 mx-16 flex justify-evenly items-center rounded-3xl gap-8 ">
            <div className="relative p-10 text-center rounded-md mt-11 bg-[#FBF6F6] dark:bg-gray-800 shadow-[9px_9px_12px_3px_rgba(0,_0,_0,_0.1)] text-TextGreen h-[490px] w-[370px]">
              ...
              <div className="flex justify-between items-center mt-10">
                ...
                <button class="text-TextGreen dark:bg-gray-700 dark:text-white bg-[#BFF4E4] rounded-lg cursor-pointer p-2">
                  وضعیت دوره
                </button>
              </div>

              <p className="rtl mt-6 text-[#1A1E21] dark:text-white text-xl">
                آشنایی با برنامه نویسی با وردپرس
              </p>
              ...
              <button class="w-[240px] h-[40px] text-white bg-[#5BE1B9] dark:bg-gray-700  rounded-lg mt-6 ">
                الان ثبت نام کن
              </button>
            </div>
            ...
            <div className="relative p-10 text-center rounded-md mt-11 bg-[#FBF6F6] dark:bg-gray-800 shadow-[9px_9px_12px_3px_rgba(0,_0,_0,_0.1)] text-TextGreen h-[490px] w-[370px]">
              ...
              <p className="rtl mt-5 leading-5 text-[#6D6767] dark:text-white text-xs text-right">
                {" "}
                لورم ایپسوم محبوب ترین و استانداردترین متن ساختگی است که توسط
                توسعه دهندگان وب، تایپوگراف ها و طراحان استفاده می شود.{" "}
              </p>
        ...
        <SwiperSlide>
          <div className="mt-16 mx-16 flex justify-evenly items-center rounded-3xl ">
            <div className="relative p-10 text-center rounded-md mt-11 bg-[#FBF6F6] dark:bg-gray-800 shadow-[9px_9px_12px_3px_rgba(0,_0,_0,_0.1)] text-TextGreen h-[490px] w-[370px]">
              ...
              <p className="rtl mt-3 ml-28  text-[#41A789] text-xs ">
                {" "}
                50 ساعت سخنwhite dark:text-whiteرانی ( 190 ساعت ){" "}
              </p>
      ...
      <div className="flex justify-center items-center mt-2">
        <button class="w-[220px] h-[60px] text-white dark:bg-gray-800 bg-[#12926C] rounded-full ">
