    ...
    <>
      ...
      <div className="mt-16 mx-2 lg:mx-16 flex justify-around items-center rounded-3xl gap-1 h-[230px] ">
        <div className="p-10 text-center rounded-md dark:bg-gray-800 dark:text-white flex flex-col items-center  bg-[#FBF6F6]  text-TextGreen">
          ...
          <p class="mt-4 rtl w-[4rem] text-black lg:w-full">دوره های طراحی UI/UX</p>
          <p className="font-medium text-2xl mt-5 text-black">28</p>
        </div>

        <div className="p-10 text-center rounded-md dark:bg-gray-800 dark:text-white flex flex-col items-center  bg-[#FBF6F6] text-TextGreen">
          <img src={categorty2} alt="" />
          <p class="mt-4 rtl w-[4rem] text-black lg:w-full">دوره های طراحی UI/UX</p>
          <p className="font-medium text-2xl mt-5 text-black">182</p>
        </div>

        <div className="p-10 text-center rounded-md dark:bg-gray-800 dark:text-white flex flex-col items-center  bg-[#FBF6F6] text-TextGreen">
          <img src={categorty3} alt="" />
          <p class="mt-4 rtl w-[4rem] text-black lg:w-full">دوره های طراحی UI/UX</p>
          <p className="font-medium text-2xl mt-5 text-black">81</p>
        </div>

        <div className="p-10 text-center rounded-md dark:bg-gray-800 dark:text-white flex flex-col items-center  bg-[#FBF6F6] text-TextGreen">
          <img src={categorty4} alt="" />
          <p class="mt-4 rtl w-[4rem] text-black lg:w-full">دوره های طراحی UI/UX</p>
          <p className="font-medium text-2xl mt-5 text-black">52</p>
        </div>
