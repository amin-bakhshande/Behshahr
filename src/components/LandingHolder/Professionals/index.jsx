...
<div className='flex justify-center items-center relative bg-gradient-to-br from-emerald-300/75 from-35% to-white h-[600px] dark:dark:bg-slate-900 dark:bg-none mt-16 '>
    ...
    <div class=" absolute top-[2rem] left-[45rem] text-center items-center ">
        <p class="text-[35px] font-bold text-TextGray dark:text-white">حرفه ای های ما</p>
        <p class="leading-10 text-TextGray dark:text-white">ساختن دنیایی بهتر، یک دوره در یک زمان</p>
    </div>
...
<div className='flex flex-col items-center '>
    ...
    <p className='text-[#086CB5] dark:text-white text-sm mt-3'>استاد برنامه نویسی</p>
    <p className='text-[#21394B] rtl text-sm mt-8 text-center dark:text-white	'>لورم ایپسوم محبوب ترین و استانداردترین متن ساختگی است که توسط توسعه دهندگان وب، تایپوگراف ها و طراحان استفاده می شود. </p>
