  ...
  return (
    <>
      <div class="bg-[#A4F6DE] mt-16 h-[300px] ">
        ...
        <div className="rtl">
          <p>اخبار آموزشگاه</p>
          <p className="mt-5">برای دریافت اخبار بروز آموزشگاه ایمیل خود را وارد کنید.</p>
          <div className="pt-14">
            <input className="w-[200px] h-[40px] rounded-r-lg" type="text" placeholder="    example@gmail.com" />
            <button class="w-[60px] h-[40px] rounded-l-lg
                                     text-[#21394B] bg-BgGreen right-0 bottom-0">ثبت</button>
          </div>
        </div>
        ...
        <div className="flex justify-around items-center mt-4">
            ...
            <div className="flex justify-center items-center">
                <p className="">کلیه حقوق این وب سایت برای آکادمی اچ وان محفوظ است.©</p>
