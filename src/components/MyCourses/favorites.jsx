    ...
    <>
      <div className="w-[45rem] lg:w-[70rem] h-[43rem] my-[1rem] border-[1px] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
        <div className="rounded-lg text-nowrap mt-6 mr-6 lg:mr-20 ">
          <button onClick={() => setShow(1)} className="group hover:bg-[#A4F6DE] bg-[#A4F6DE] dark:bg-gray-900 w-[21rem] lg:w-[30rem] h-[3rem] text-[#22445D] dark:text-white text-lg">
            دوره های مورد علاقه من
          </button>
          <button onClick={() => setShow(2)} className="group hover:bg-[#A4F6DE]  dark:bg-gray-700 border-[2px] border-[#A4F6DE] w-[21rem] lg:w-[30rem] h-[3rem] text-[#22445D] dark:text-white text-lg">
            مقالات مورد علاقه من
          </button>
        </div>

      {show === 1 ? <div className="w-[43rem] lg:w-[66rem] h-[35rem] mx-auto my-[2rem] bg-[#FBF6F6] dark:bg-gray-700 border-[1px] rounded-lg shadow-2xl">
          ...
          {data?.map((item) => {
            return (
              <div className=" hover:bg-orange-100 mt-2 text-nowrap text-[#22445D] text-[12px] bg-[#ffff] h-[3.5rem] rounded-2xl flex justify-start rtl gap-14 xl:gap-28  shadow-sm border-[1px] py-[1.2rem] px-[1.4rem] mx-[1rem]">
               ...
               <p className=" text-center w-[204px]"> {moment(item?.lastUpdate).locale("fa").format("YYYY/MM/DD")}</p>
                <button onClick={() => deleteFavoriteCourses(item.favoriteId)} className="w-[204px] h-[2rem] my-[-0.5rem]">
                  <img
        ...
        {show === 2 ? <div className="w-[43rem] lg:w-[66rem] h-[35rem] mx-auto my-[2rem] bg-[#FBF6F6] dark:bg-gray-700 border-[1px] rounded-lg shadow-2xl">
          ...
          {news?.map((item) => {
            return (
              <div className=" hover:bg-orange-100 mt-2 text-nowrap text-[#22445D] text-[12px] bg-[#ffff] h-[3.5rem] rounded-2xl flex justify-start rtl gap-14 xl:gap-28  shadow-sm border-[1px] py-[1.2rem] px-[1.4rem] mx-[1rem]">
               ...
               <p className=" text-center w-[204px]"> {moment(item?.updateDate).locale("fa").format("YYYY/MM/DD")}</p>
                <button onClick={() => deleteFavoriteNews(item.favoriteId)} className="w-[204px] h-[2rem] ml-4 my-[-0.5rem]">
                  <img 
                    className="text-[#22445D] mr-14 h-[1.5rem] "
                    src={recycle}
                    alt=""
